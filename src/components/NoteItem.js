            ...
            <div className="card p-1" style={{ width: "18rem" }}>
                <div className="card-body">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        <i
                            className="p-1 edit-icon"
                            onClick={() => {
                                props.udpateNoteModalOpen(props.note);
                            }}>
                        ...
                        <i className="p-1 delete-icon" onClick={handleDeleteNote}>
                            <svg xmlns="http://www.w3.org/2000/svg" height="1.1rem" viewBox="0 0 448 512" fill="maroon">
